      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: w / 15, vertical: h / 60),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: notes[index].images!.length != 0
                            ? DecorationImage(
                                image: NetworkImage(notes[index].images!.first),
                                fit: BoxFit.cover,
                              )
                            : DecorationImage(
                                image:
                                    AssetImage("assets/images/room/2(1).png"),
                                fit: BoxFit.cover,
                              ),
                      ),
                    ),
